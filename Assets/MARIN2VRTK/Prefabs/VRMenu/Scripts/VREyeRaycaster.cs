...
// NOTICE: THIS IS NOT THE ORIGINAL VREyeRaycaster SCRIPT. SLIGHT MODIFICATIONS
// WERE MADE FOR THE MARIN2VRTK PACKAGE.
...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        [SerializeField] private LayerMask m_ExclusionLayers;            // Layers to include to the raycast.
        ...
        [SerializeField] private bool m_AllowDebugMouse;
        ...
        private void OnEnable()
        {
            ...
            if (m_Camera == null)
            {
                if (Camera.main != null)
                {
                    Debug.Log("VREyeRaycaster: No camera specified. Using main camera.");
                    m_Camera = Camera.main.transform;
                }
                else
                {
                    Debug.LogError("VREyeRaycaster: No camera specified and no main camera found.");
                }
            }
        }
        ...
        private void Update()
        {
            if (m_AllowDebugMouse) MouseRaycast();
            else EyeRaycast();
        }
